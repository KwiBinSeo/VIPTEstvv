...
<head>
	...
	<script type="text/javascript">
 	function goPage_Up() {
		// 페이지 이동
		document.addForm.action="Equipment_count.do";
 	...
 	function goPage_Down() {
 		if(<%=equipment_count%> <= 1) {
			...
			// 페이지 이동
			document.subForm.action="Equipment_count2.do";
		...
		<section class="content">
			<div class="col-md-12">
				<div class="box box-danger">
					...
					<div class="box-body">  
						<div class="col-md-16">		  
							<form id="frm" action="/smartplace/menu1by4Toby5.do" method="POST" class="form-group">
								<div  class="table-responsive">
		        					<table class="table no-margin text-center">			
										...
										<tbody>
											...
											<tr>
												<td><center>
													<input type="text" list="countries" name="<%="equip"+equipment_index %>" />
													<datalist id="countries">
														<%for(int index = 0; index < count; index++) {%>
														<option name="<%="equip"+index%>" value="<%=rsarray[index]%>"><%=rsarray[index]%></option>
														<%}%>
													</datalist>
												</center></td>
												<td><center><input type="text" name="<%="yest"+equipment_index%>" width=50></center></input></td>
												<td><center><input type="text" name="<%="today"+equipment_index%>" width=50></center></input></td>
												<td><center><input type="text" name="<%="total"+equipment_index%>" width=50></center></input></td>
											</tr>
											<% }} else {
											for(int equipment_index = 0; equipment_index < equipment_count; equipment_index++) { %>
											<tr>
												<td><center>
													<input type="text" list="countries" name="<%="equip"+equipment_index %>" value="<%=equipment.get(equipment_index)%>"/>
													<datalist id="countries">
														<%for(int index = 0; index < count; index++) {%>
														<option name="<%="equip"+index%>" value="<%=rsarray[index]%>"><%=rsarray[index]%></option>
														<%}%>
												...
												<td><center><input type="text" name="<%="yest"+equipment_index%>" width=50 value="<%=equipment_yesterday.get(equipment_index)%>"></center></input></td>
												<td><center><input type="text" name="<%="today"+equipment_index%>" width=50 value="<%=equipment_today.get(equipment_index)%>"></center></input></td>
												<td><center><input type="text" name="<%="total"+equipment_index%>" width=50 value="<%=equipment_total.get(equipment_index)%>"></center></input></td>
											</tr>									
											<% }} %>
										</tbody>
									</table>
