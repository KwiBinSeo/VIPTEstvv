...
<%
	...
	String[] rsarray1 = (String[])request.getAttribute("rsarray");
	// DB 연결 부분 끝
%>
			...
			<div class="col-md-12">
				<div class="box box-danger">
					<div class = "box-header with-border">
						...
						<div class="pull-right">
							<form id="back" action="/smartplace/menu1by3.jsp" method="POST" style="float:left; margin: 5px">
								<input type="submit" value="BACK" class="btn btn-primary btn-block "></input>
							</form>
							<form id="next" action="/smartplace/menu1by5.jsp" method="POST" style="float:left; margin: 5px">
					...
					<div class="box-body">    
						...
						<div class = "box-header with-border">
							<div class="pull-right">
								<form id="add" action="javascript:goPage_Up()" method="POST" style="float:left; margin: 5px">
									<input type="submit" value="+" class="btn btn-primary btn-block "></input>
								</form>
								<form id="sub" action="javascript:goPage_Down()" method="POST" style="float:left; margin: 5px">
									<input type="submit" value="-" class="btn btn-primary btn-block "></input>
								</form>
							</div>
						</div>
