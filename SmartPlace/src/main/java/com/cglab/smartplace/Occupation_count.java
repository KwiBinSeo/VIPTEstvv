...
/**
 * Servlet implementation class Occupation_count
 */
public class Occupation_count extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		occupation_count++; //occupation_count 값을 +1 증가
		try {
